...
*/
	...
	***********************************************************/
	...
	blck_killEmptyAIVehicles = flase; // when true, the AI vehicle will be extensively damaged once all AI have gotten out.
	blck_AIPatrolVehicles = ["I_G_Offroad_01_armed_F","B_MRAP_01_hmg_F","O_MRAP_02_hmg_F"]; // Type of vehicle spawned to defend AI bases
