...
_servicePointClasses = ["Land_A_FuelStation_Build","Land_A_FuelStation_Shed","MAP_A_FuelStation_Build","MAP_A_FuelStation_Shed","Land_Ind_FuelStation_Build_EP1","Land_Ind_FuelStation_Shed_EP1","Land_FuelStation_Build_PMC","Land_FuelStation_Shed_PMC","FuelStation","Land_A_FuelStation_Feed","Land_Ind_FuelStation_Feed_EP1","Land_FuelStation_Feed_PMC"]; // service point classes (can be house, vehicle and unit classes)
...
_repair_costs = [
        ...
        ["Tank",300], // 250 Crypto Tank
        ["Tracked_APC",200], // 200 Crypto Tracked_APC
        ["Wheeled_APC",100], // 150 Crypto Wheeled_APC
        ["AllVehicles",50] // 100 Crypto all other vehicles
];
